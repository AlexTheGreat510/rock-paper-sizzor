...
while running:
    ...
    player1_choice = str(input(f"\n({run_count}) PLAYER-1 [{player1_score}]--> "))
    ...
    match (player1_choice):
        ...
        case "stats":
            print(f"\n({run_count}) PLAYER-1 [{player1_score}] vs PLAYER-2 [{player2_score}]")
            continue
    ...
    print(f"({run_count}) PLAYER-2 [{player2_score}]--> {player2_choice}\n")
    ...
    if (player1_choice == "rock" and player2_choice == "sizzor" or player1_choice == "paper" and player2_choice == "rock" or player1_choice == "sizzor" and player2_choice == "paper"):
        player1_score += 1
        print(f"({run_count}) PLAYER-1 [{player1_score}]--> Winner!")
        print(f"({run_count}) PLAYER-2 [{player2_score}]--> Looser!")
